...
class Attention(nn.Module):
    def __init__(self, mask_flag=False, scale=None, dropout=0.0):
...
class AttentionLayer(nn.Module):
    def __init__(
        ...
        self.attn = Attention(mask_flag=mask_flag, scale=scale, dropout=dropout)
